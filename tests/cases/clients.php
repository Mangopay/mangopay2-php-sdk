...
class Clients extends Base {
    ...
    function test_Clients_Save() {
        ...
        $this->assertEqual($this->_api->Config->ClientId, $saveClients->ClientId);
    }
    ...
    function test_Clients_UploadLogo_WrongFileString(){
        $logo = new \MangoPay\ClientLogoUpload();
        $logo->File = "qqqq";
    ...
    function test_Clients_UploadLogo_CorrectFileString() {
        $logo = new \MangoPay\ClientLogoUpload();
    ...
    function test_Clients_UploadLogoFromFile_EmptyFilePath() {
    ...
    function test_Clients_UploadLogoFromFile_WrongFilePath() {
