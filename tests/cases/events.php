...
class Events extends Base {
    ...
    function test_GetEventList_PayinNormalCreated() {
        ...
        $filter = new \MangoPay\Tools\FilterEvents();
        $filter->BeforeDate = $payIn->CreationDate;
        $filter->AfterDate = $payIn->CreationDate;
        $filter->EventType = \MangoPay\Enums\EventType::PayinNormalCreated;
    ...
    function test_GetEventList_PayinNormalSucceeded() {
        ...
        $filter->EventType = \MangoPay\Enums\EventType::PayinNormalSucceeded;
        $pagination = new \MangoPay\Types\Pagination();
    ...
    function test_GetEventList_PayoutNormalCreated() {
        ...
        $filter->EventType = \MangoPay\Enums\EventType::PayoutNormalCreated;
        $pagination = new \MangoPay\Types\Pagination();
    ...
    function test_GetKycDocumentsList_KycCreated(){
        ...
        $filter->EventType = \MangoPay\Enums\EventType::KycCreated;
        $pagination = new \MangoPay\Types\Pagination();
