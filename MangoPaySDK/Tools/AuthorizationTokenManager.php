...
class AuthorizationTokenManager extends ApiBase {
    ...
    /**
     * Storage object
     * @var \MangoPay\Tools\IStorageStrategy
     */
     ...
     * @return \MangoPay\Types\OAuthToken Valid OAuthToken instance.
     */
     ...
     * @param \MangoPay\Tools\IStorageStrategy $customStorageStrategy IStorageStrategy interface implementation.
     */
