    ...
    public function GetDependsObjects() {
        return array(
            'PaymentType' => array(
                ...
                'CARD' => '\MangoPay\Types\PayInPaymentDetailsCard',
                'PREAUTHORIZED' => '\MangoPay\Types\PayInPaymentDetailsPreAuthorized',
                'BANK_WIRE' => '\MangoPay\Types\PayInPaymentDetailsBankWire',
                'DIRECT_DEBIT' => '\MangoPay\Types\PayInPaymentDetailsDirectDebit',
                // ...and more in future...
            ),
            'ExecutionType' => array(
                '_property_name' => 'ExecutionDetails',
                'WEB' => '\MangoPay\Types\PayInExecutionDetailsWeb',
                'DIRECT' => '\MangoPay\Types\PayInExecutionDetailsDirect',
                // ...and more in future...
            )
        );
    }
