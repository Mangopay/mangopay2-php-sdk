    ...
    public function GetDependsObjects() {
        return array(
            'Type' => array(
                ...
                'IBAN' => '\MangoPay\Types\BankAccountDetailsIBAN',
                'GB' => '\MangoPay\Types\BankAccountDetailsGB',
                'US' => '\MangoPay\Types\BankAccountDetailsUS',
                'CA' => '\MangoPay\Types\BankAccountDetailsCA',
                'OTHER' => '\MangoPay\Types\BankAccountDetailsOTHER',
            )
        );
    }
